...
import petSnack_StackBottle1 from "../../../assets/pet/6. petSnack_StackBottle1.jpg";
import petSnack_StackBottle_Desc1 from "../../../assets/pet/6. petSnack_StackBottle_Desc1.jpg";
import petSnack_StackBottle_Desc2 from "../../../assets/pet/6. petSnack_StackBottle_Desc2.jpg";
import petSnack_StackBottle_Desc3 from "../../../assets/pet/6. petSnack_StackBottle_Desc3.jpg";
import petSnack_StackBottle_Desc4 from "../../../assets/pet/6. petSnack_StackBottle_Desc4.jpg";
import petSnack_StackBottle_Desc5 from "../../../assets/pet/6. petSnack_StackBottle_Desc5.jpg";

const Pd_Pet6 = () => {
  return (
    <div className="Pd_Pet6_wrapper">
      <div className="Pd_Pet6_Header">
        <Header_loginOK />  
      </div> {/** Pd_Pet6_Header end */}
      <div className="Pd_Pet6_Content">
         <div className="Pd_Pet6_body">
           <div id="detail">
             <div className="detail_top_wrap">
               {/** 상품 이미지 */}
               <div className="prdimg">
                 <div className="add_img">
                    <img src={petSnack_StackBottle1} alt="3단스택 보틀" />
                 </div>
           
                   <div className="detail_info">
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 1st 이미지 (장원영 단독 착용사진) */}
                       <img src={petSnack_StackBottle_Desc1} />
                     </div>    {/** img_wrapper end */}
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 2nd 이미지 (장원영 + 옷 단독 + 외국인 모델 착용사진) */}
                       <img src={petSnack_StackBottle_Desc2} />
                     </div>    {/** img_wrapper end */}
                     <div className="img _wrapper" style={{ textAlign: "center" }}>
                       <img src={petSnack_StackBottle_Desc3} />
                     </div>		{/** img_wrapper end */}
                     <div className="img _wrapper" style={{ textAlign: "center" }}>
                       <img src={petSnack_StackBottle_Desc4} />
                     </div>		{/** img_wrapper end */}
                     <div className="img _wrapper" style={{ textAlign: "center" }}>
                       <img src={petSnack_StackBottle_Desc5} />
                     </div>		{/** img_wrapper end */}
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 바잇미 3단 스택 보틀 </h3>
                       <p className="summary">3단스택 보틀</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">17,900 원</span>
                           <span className="sell sellY">
                             <strong>16,110</strong>
                           </span>   {/** sell sellY end */}
                         </div>    {/** top_price end */}
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="3 stack_Bottle">3단스택 보틀</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Pet6_body end */}          
      </div>    {/** Pd_Pet6_Content end */}
      <div className="Pd_Pet6_Footer">
        <Footer />  
      </div>   {/** Pd_Pet6_Footer end */}
    </div>  /** Pd_Pet6_wrapper end */
  );
};

export default Pd_Pet6;