...
import defecationBag1 from "../../../assets/pet/2. defecationBag1.jpg";
import defecationBag2 from "../../../assets/pet/2. defecationBag2.jpg";
import defecationBag3 from "../../../assets/pet/2. defecationBag3.jpg";
import defecationBag_Desc1 from "../../../assets/pet/2. defecationBag_Desc1.jpg";
import defecationBag_Desc2 from "../../../assets/pet/2. defecationBag_Desc2.jpg";
import defecationBag_Desc3 from "../../../assets/pet/2. defecationBag_Desc3.jpg";
...
const Pd_Pet2 = () => {
  ...
  return (
    <div className="Pd_Pet2_wrapper">
      <div className="Pd_Pet2_Header">
        <Header_loginOK />  
      </div> {/** Pd_Pet2_Header end */}
      <div className="Pd_Pet2_Content">
         <div className="Pd_Pet2_body">
           <div id="detail">
               ...
               <div className="prdimg">
                  <div className="carousel_container">
                    ...
                    <div className="add_img">
                      <img src={images[currentIndex]} alt={`배변봉투 세트 ${currentIndex + 1}`} />
                    </div>
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 바잇미 웁스백 반려동물 배변봉투 디스펜서 세트 </h3>
                       <p className="summary">배변봉투 세트</p>
                       <div className="price">
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="defecationBag">배변봉투 세트</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Pet2_body end */}      
      </div>    {/** Pd_Pet2_Content end */}
      <div className="Pd_Pet2_Footer">
        <Footer />  
      </div>   {/** Pd_Pet2_Footer end */}
    </div>  /** Pd_Pet2_wrapper end */
  );
};

export default Pd_Pet2;