...
import petSnack_Bottle1 from "../../../assets/pet/5. petSnack_Bottle1.jpg";
import petSnack_Bottle2 from "../../../assets/pet/5. petSnack_Bottle2.jpg";
import petSnack_Bottle3 from "../../../assets/pet/5. petSnack_Bottle3.jpg";
import petSnack_Bottle4 from "../../../assets/pet/5. petSnack_Bottle4.jpg";
import petSnack_BottleDesc1 from "../../../assets/pet/5. petSnack_BottleDesc1.jpg";
import petSnack_BottleDesc2 from "../../../assets/pet/5. petSnack_BottleDesc2.jpg";
import petSnack_BottleDesc3 from "../../../assets/pet/5. petSnack_BottleDesc3.jpg";
import petSnack_BottleDesc4 from "../../../assets/pet/5. petSnack_BottleDesc4.jpg";
...
const Pd_Pet5 = () => {
  ...
  return (
    <div className="Pd_Pet5_wrapper">
      <div className="Pd_Pet5_Header">
        <Header_loginOK />  
      </div> {/** Pd_Pet5_Header end */}
      <div className="Pd_Pet5_Content">
         <div className="Pd_Pet5_body">
           <div id="detail">
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 바잇미 미니 간식보틀 </h3>
                       <p className="summary">간식보틀</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">5,900 원</span>
         ...
         </div>   {/** Pd_Pet5_body end */}          
      </div>    {/** Pd_Pet5_Content end */}
      <div className="Pd_Pet5_Footer">
        <Footer />  
      </div>   {/** Pd_Pet5_Footer end */}
    </div>  /** Pd_Pet5_wrapper end */
  );
};

export default Pd_Pet5;