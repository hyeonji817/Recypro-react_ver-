...
import peachKeyRing1 from "../../../assets/life/6. peach_KeyRing1.jpg"; 
import peachKeyRing2 from "../../../assets/life/6. peach_KeyRing2.jpg"; 
import peachKeyRing_Desc from "../../../assets/life/6. peach_KeyRing_Desc1.jpg"; 
...
const Pd_Life6 = () => {
  ...
  return (
    <div className="Pd_Life6_wrapper">
      <div className="Pd_Life6_Header">
        <Header_loginOK />  
      </div> {/** Pd_Life6_Header end */}
      <div className="Pd_Life6_Content">
         <div className="Pd_Life6_body">
           <div id="detail">
               ...
               <div className="prdimg">
                <div className="carousel_container">
                  ...
                  <div className="add_img">
                    <img src={images[currentIndex]} alt={`키링 악세사리 ${currentIndex + 1}`} />
                  </div>
                  <button className="arrow right" onClick={handleNext}>
                   ...
                   <div className="detail_info">
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	
                       <img src={peachKeyRing_Desc} />
                       <p style={{ textAlign: "center" }}>사진 순서대로</p>
                       <p style={{ textAlign: "center" }}>소 / 대</p>
                     </div>   
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 공정무역 양모펠트 키링 - 복숭아 </h3>
                       <p className="summary">복숭아 키링</p>
                       <div className="price">
         ...
         </div>   {/** Pd_Life6_body end */}       
      </div>    {/** Pd_Life6_Content end */}
      <div className="Pd_Life6_Footer">
        <Footer />  
      </div>   {/** Pd_Life6_Footer end */}
    </div>  /** Pd_Life6_wrapper end */
  );
};

export default Pd_Life6;