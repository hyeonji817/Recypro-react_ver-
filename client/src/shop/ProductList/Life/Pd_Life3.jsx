...
import pumpkin_KeyRing from "../../../assets/life/3. pumpkin_KeyRing1.jpg";
...
const Pd_Life3 = () => {
  return (
    <div className="Pd_Life3_wrapper">
      <div className="Pd_Life3_Header">
        <Header_loginOK />  
      </div>     {/** Pd_Life3_Header end */}
      <div className="Pd_Life3_Content">
      <div className="Pd_Life3_body">
           <div id="detail">
               ...
               <div className="prdimg">
                 <div id="addimg" className="addimg">
                   <div className="add_img">
                      <img src={pumpkin_KeyRing} alt="호박 키링" />
                    </div>
                 </div>    {/** addimg end */}
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 공정무역 양모펠트 키링 - 호박 </h3>
                       <p className="summary">호박 키링</p>
                       <div className="price">
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="pumpkin_KeyRing">호박키링</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Life3_body end */}       
      </div>    {/** Pd_Life3_Content end */}
      <div className="Pd_Life3_Footer">
        <Footer />
      </div>     {/** Pd_Life3_Footer end */}
    </div>
  );
};

export default Pd_Life3;