...
import catKeyRing1 from "../../../assets/life/5. cat_KeyRing1.jpg"; 
import catKeyRing2 from "../../../assets/life/5. cat_KeyRing2.jpg"; 
import catKeyRing3 from "../../../assets/life/5. cat_KeyRing3.jpg"; 
import catKeyRing4 from "../../../assets/life/5. cat_keyRing4.jpg";
import catKeyRing5 from "../../../assets/life/5. cat_keyRing5.jpg"; 
import catKeyRing_Desc1 from "../../../assets/life/5. cat_KeyRing_Desc1.jpg"; 
...
const Pd_Life5 = () => {
  ...
  return (
    <div className="Pd_Life5_wrapper">
      <div className="Pd_Life5_Header">
        <Header_loginOK />
      </div>     {/** Pd_Life5_Header end */}

      <div className="Pd_Life5_Content">
      <div className="Pd_Life5_body">
           <div id="detail">
               ...
               <div className="prdimg">
                <div className="carousel_container">
                  ...
                  <div className="add_img">
                    <img src={images[currentIndex]} alt={`고양이 키링 ${currentIndex + 1}`} />
                  </div>
                ...
                <div className="detail_info">
                  <div className="img_wrapper" style={{ textAlign: "center" }}>
                    <img src={catKeyRing_Desc1} />
                    <p style={{ textAlign: "center" }}>사진 순서대로</p>
                    <p style={{ textAlign: "center" }}>(윗줄) 노랑 / 보라<br />(아랫줄) 하늘 / 검정</p>
                  </div>    
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 스모어웨이브 공정무역 키링 - 고양이 </h3>
                       <p className="summary">고양이 키링</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">7,000 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="sora">소라</option>
                             <option value="보라::0::0::9508::cpx0::">보라</option>
         ...
         </div>   {/** Pd_Life5_body end */}
      </div>    {/** Pd_Life5_Content end */}

      <div className="Pd_Life5_Footer">
        <Footer />  
      </div>     {/** Pd_Life5_Footer end */}
    </div>
  );
};

export default Pd_Life5;