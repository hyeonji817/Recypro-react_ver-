...
import tableMat1 from "../../../assets/life/7. table_Mat1.jpg"; 
import tableMat2 from "../../../assets/life/7. table_Mat2.jpg"; 
import tableMat3 from "../../../assets/life/7. table_Mat3.jpg"; 
import tableMat4 from "../../../assets/life/7. table_Mat4.jpg"; 
import tableMat5 from "../../../assets/life/7. table_Mat5.jpg"; 
import tableMat_Desc1 from "../../../assets/life/7. table_Mat_Desc1.jpg";
import tableMat_Desc2 from "../../../assets/life/7. table_Mat_Desc2.jpg"; 
...
const Pd_Life7 = () => {
  ...
  return (
    <div className="Pd_Life7_wrapper">
      <div className="Pd_Life7_Header">
        <Header_loginOK />  
      </div> {/** Pd_Life7_Header end */}
      <div className="Pd_Life7_Content">
         <div className="Pd_Life7_body">
           <div id="detail">
               ...
               <div className="prdimg">
                  <div className="carousel_container">
                      ...
                      <div className="add_img">
                        <img src={images[currentIndex]} alt={`테이블 매트 ${currentIndex + 1}`} />
                      </div>
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] 키친클로스 테이블매트 (스티치) </h3>
                       <p className="summary">테이블매트</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">8,000 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="블랙::0::0::9508::cpx0::">블랙</option>
         ...
         </div>   {/** Pd_Life7_body end */}    
      </div>    {/** Pd_Life7_Content end */}

      <div className="Pd_Life7_Footer">
        <Footer />  
      </div>   {/** Pd_Life7_Footer end */}
    </div>  /** Pd_Life7_wrapper end */
  );
};

export default Pd_Life7; 