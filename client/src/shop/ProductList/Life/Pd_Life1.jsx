...
// 이미지 불러들이기 
import abocado from "../../../assets/life/1. abocado_couple.jpg"; 
import couponBanner from "../../../assets/coupon_banner.jpg";

const Pd_Life1 = () => {
  return (
    <div className="Pd_Life1_wrapper">
      <div className="Pd_Life1_Header">
        <Header_loginOK />
      </div>
      <div className="Pd_Life1_Content">
      <div className="Pd_Life1_body">
          <div id="detail">
            <div className="detail_top_wrap">
              {/** 상품 이미지 */}
              <div className="prdimg">
                <div className="add_img">
                  <img src={abocado} alt="아보카도 커플 키링" />
                </div>
              ...
              <div className="info_scroll">
                <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                  <div className="wrap_prd">
                    {/** 상품정보 & 버튼 */}
                    <div className="info">
                      <h3 className="name">[지구pick] 공정무역 양모펠트 키링 - 아보카도 커플 </h3>
                      <p className="summary">아보카도 커플 키링</p>
                      <div className="price">
                        <div className="top_price">
                          <span className="consumer consumerY">13,000 원</span>
                      ...
                      <div className="opt_list">
                        ...
                        <div className="td">
                          <select name="option1" className="wing_multi_option pno4844 necessary_Y">
                            <option value="">::선택::</option>
                            <option value="abocado">아보카도 커플</option>
                          </select>
                        </div>    {/** td end */}
                      </div>    {/** opt_list end */}
        ...
        </div>   {/** Pd_Life1_body end */}
      </div>
      <div className="Pd_Life1_Footer"></div>
    </div>
  );
};

export default Pd_Life1;