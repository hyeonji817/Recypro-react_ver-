...
import KeyRingAcc1 from "../../../assets/life/2. keyRing_accessary1.jpg"; 
import KeyRingAcc2 from "../../../assets/life/2. keyRing_accessary2.jpg";

const Pd_Life2 = () => {
  const images = [KeyRingAcc1, KeyRingAcc2];
  ...
  return (
    <div className="Pd_Life2_wrapper">
      <div className="Pd_Life2_Header">
        <Header_loginOK />
      </div>
      <div className="Pd_Life2_Content">
        <div className="Pd_Life2_body">
           <div id="detail">
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 스모어웨이브 공정무역 키링 악세서리 </h3>
                       <p className="summary">키링 악세사리</p>
                       <div className="price">
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="yellow">레드</option>
                             <option value="blue">블랙</option>
         ...
         </div>   {/** Pd_Life2_body end */}
        </div>    {/** Pd_Life2_Content end */}
      <div className="Pd_Life2_Footer"></div>
    </div>
  );
};

export default Pd_Life2;