...
import zeroHairSet1 from "../../../assets/bath/7. zeroHairSet1.jpg";
import zeroHairSet2 from "../../../assets/bath/7. zeroHairSet2.jpg";
import zeroHairSet3 from "../../../assets/bath/7. zeroHairSet3.jpg";
import zeroHairSet4 from "../../../assets/bath/7. zeroHairSet4.jpg";
import zeroHairSet_Desc1 from "../../../assets/bath/7. zeroHairSet_Desc1.jpg";
...
const Pd_Bath7 = () => {
  ...
  return (
    <div className="Pd_Bath7_wrapper">
      <div className="Pd_Bath7_Header">
        <Header_loginOK />  
      </div> {/** Pd_Bath7_Header end */}
      <div className="Pd_Bath7_Content">
         <div className="Pd_Bath7_body">
           <div id="detail">
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] 제로 헤어 세트 </h3>
                       <p className="summary">헤어세트</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">22,900 원</span>
                           <span className="sell sellY">
                             <strong>20,610</strong>
                           </span>   {/** sell sellY end */}
                         </div>    {/** top_price end */}
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="hairSet">헤어세트</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Bath7_body end */}      
      </div>    {/** Pd_Bath7_Content end */}
      <div className="Pd_Bath7_Footer">
        <Footer />  
      </div>   {/** Pd_Bath7_Footer end */}
    </div>  /** Pd_Bath7_wrapper end */
  );
};

export default Pd_Bath7;