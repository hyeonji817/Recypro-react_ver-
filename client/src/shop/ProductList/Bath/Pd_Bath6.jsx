...
import toothBrush_Holder1 from "../../../assets/bath/6. toothBrush_Holder1.jpg";
import toothBrush_Holder2 from "../../../assets/bath/6. toothBrush_Holder2.jpg";
import toothBrush_HolderDesc1 from "../../../assets/bath/6. toothBrush_HolderDesc1.jpg";
import toothBrush_HolderDesc2 from "../../../assets/bath/6. toothBrush_HolderDesc2.jpg";
import toothBrush_HolderDesc3 from "../../../assets/bath/6. toothBrush_HolderDesc3.jpg";
import toothBrush_HolderDesc4 from "../../../assets/bath/6. toothBrush_HolderDesc4.jpg";
...
const Pd_Bath6 = () => {
  ...
  return (
    <div className="Pd_Bath6_wrapper">
      <div className="Pd_Bath6_Header">
        <Header_loginOK />  
      </div> {/** Pd_Bath6_Header end */}
      <div className="Pd_Bath6_Content">
         <div className="Pd_Bath6_body">
           <div id="detail">
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 노플라스틱선데이 칫솔꽂이 </h3>
                       <p className="summary">칫솔꽂이</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">5,000 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="lavendar">라벤더</option>
                             <option value="blue">블루</option>
                             <option value="그레이::0::0::9508::cpx0::">그레이</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Bath6_body end */}        
      </div>    {/** Pd_Bath6_Content end */}
      <div className="Pd_Bath6_Footer">
        <Footer />  
      </div>   {/** Pd_Bath6_Footer end */}
    </div>  /** Pd_Bath6_wrapper end */
  );
};

export default Pd_Bath6;