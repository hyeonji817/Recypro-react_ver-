...
import sundayTube1 from "../../../assets/bath/3. sundayTube1.jpg"; 
import sundayTube2 from "../../../assets/bath/3. sundayTube2.jpg"; 
import sundayTube_Desc1 from "../../../assets/bath/3. sundayTube_Desc1.jpg"; 
import sundayTube_Desc2 from "../../../assets/bath/3. sundayTube_Desc2.jpg"; 
import sundayTube_Desc3 from "../../../assets/bath/3. sundayTube_Desc3.jpg"; 
import sundayTube_Desc4 from "../../../assets/bath/3. sundayTube_Desc4.jpg"; 
import sundayTube_Desc5 from "../../../assets/bath/3. sundayTube_Desc5.jpg"; 
import sundayTube_Desc6 from "../../../assets/bath/3. sundayTube_Desc6.jpg"; 
import sundayTube_Desc7 from "../../../assets/bath/3. sundayTube_Desc7.jpg"; 
...
const Pd_Bath3 = () => {
  ...
  return (
    <div className="Pd_Bath3_wrapper">
      <div className="Pd_Bath3_Header">
        <Header_loginOK />  
      </div> {/** Pd_Bath3_Header end */}
      <div className="Pd_Bath3_Content">
         <div className="Pd_Bath3_body">
           <div id="detail">
             <div className="detail_top_wrap">
               ...
               <div className="carousel_container">
                    ...
                    <div className="add_img">
                      <img src={images[currentIndex]} alt={`선데이 튜브짜개 ${currentIndex + 1}`} />
                    </div>
                   ...
                   <div className="detail_info">
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 1st 이미지 (장원영 단독 착용사진) */}
                       <img src={sundayTube_Desc1} />
                     </div>    {/** img_wrapper end */}
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 2nd 이미지 (장원영 + 옷 단독 + 외국인 모델 착용사진) */}
                       <img src={sundayTube_Desc2} />
                     </div>    {/** img_wrapper end */}
                     <div className="img _wrapper" style={{ textAlign: "center" }}>
                       <img src={sundayTube_Desc3} />
                     </div>		{/** img_wrapper end */}
                     <div className="img _wrapper" style={{ textAlign: "center" }}>
                       <img src={sundayTube_Desc4} />
                     </div>		{/** img_wrapper end */}
                     <div className="img _wrapper" style={{ textAlign: "center" }}>
                       <img src={sundayTube_Desc5} />
                     </div>		{/** img_wrapper end */}
                     <div className="img _wrapper" style={{ textAlign: "center" }}>
                       <img src={sundayTube_Desc6} />
                     </div>		{/** img_wrapper end */}
                     <div className="img _wrapper" style={{ textAlign: "center" }}>
                       <img src={sundayTube_Desc7} />
                     </div>		{/** img_wrapper end */}
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 노플라스틱선데이 튜브짜개 </h3>
                       <p className="summary">튜브짜개</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">4,000 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="sundayTube">튜브짜개 1매</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Bath3_body end */}        
      </div>    {/** Pd_Bath3_Content end */}
      <div className="Pd_Bath3_Footer">
        <Footer />  
      </div>   {/** Pd_Bath3_Footer end */}
    </div>  /** Pd_Bath3_wrapper end */
  );
};

export default Pd_Bath3;