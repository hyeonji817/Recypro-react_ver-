...
import organicFarming_Towel1 from "../../../assets/bath/1. organicFarming_Towel1.jpg"; 
import organicFarming_Towel2 from "../../../assets/bath/1. organicFarming_Towel2.jpg"; 
import organicFarming_Towel3 from "../../../assets/bath/1. organicFarming_Towel3.jpg"; 
import organicFarming_Towel4 from "../../../assets/bath/1. organicFarming_Towel4.jpg"; 
import organicFarming_Towel5 from "../../../assets/bath/1. organicFarming_Towel5.jpg"; 
import organicFarming_Towel6 from "../../../assets/bath/1. organicFarming_Towel6.jpg"; 
import organicFarming_Towel7 from "../../../assets/bath/1. organicFarming_Towel7.jpg"; 
import orgaincFarming_TowerlDesc from "../../../assets/bath/1. organicFarming_TowelDesc1.jpg";

const Pd_Bath1 = () => {
  const images = [
    organicFarming_Towel1,
    organicFarming_Towel2,
    organicFarming_Towel3,
    organicFarming_Towel4,
    organicFarming_Towel5,
    organicFarming_Towel6,
    organicFarming_Towel7
  ];
  ...
  return (
    <div className="Pd_Bath1_wrapper">
      <div className="Pd_Bath1_Header">
        <Header_loginOK />  
      </div> {/** Pd_Bath1_Header end */}
      <div className="Pd_Bath1_Content">
         <div className="Pd_Bath1_body">
           <div id="detail">
                  ...
                  <div className="carousel_container">
                   ...
                   <div className="detail_info">
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 1st 이미지 (장원영 단독 착용사진) */}
                       <img src={orgaincFarming_TowerlDesc} />
                     </div>   	
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] 유기농 수건 (1매) </h3>
                       <p className="summary">유기농 수건</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">10,900 원</span>
         ...
         </div>   {/** Pd_Bath1_body end */}      
      </div>    {/** Pd_Bath1_Content end */}
      <div className="Pd_Bath1_Footer">
        <Footer />  
      </div>   {/** Pd_Bath1_Footer end */}
    </div>  /** Pd_Bath1_wrapper end */
  );
};

export default Pd_Bath1;