...
import showerTowel1 from "../../../assets/bath/9. showerTowel1.jpg"; 
import showerTowel2 from "../../../assets/bath/9. showerTowel2.jpg"; 
import showerTowel3 from "../../../assets/bath/9. showerTowel3.jpg"; 
import showerTowel4 from "../../../assets/bath/9. showerTowel4.jpg";
import showerTowel_Desc1 from "../../../assets/bath/9. showerTowel_Desc1.jpg";
import showerTowel_Desc2 from "../../../assets/bath/9. showerTowel_Desc2.jpg"; 
...
const Pd_Bath9 = () => {
  ...
  return (
    <div className="Pd_Bath9_wrapper">
      <div className="Pd_Bath9_Header">
        <Header_loginOK />  
      </div> {/** Pd_Bath9_Header end */}
      <div className="Pd_Bath9_Content">
         <div className="Pd_Bath9_body">
           <div id="detail">
               ...
               <div className="prdimg">
                  <div className="carousel_container">
                    ...
                    <div className="add_img">
                      <img src={images[currentIndex]} alt={`삼베 샤워타월 ${currentIndex + 1}`} />
                    </div>
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 예고은 삼베 샤워타월 </h3>
                       <p className="summary">샤워타월</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">11,900 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="showerTowel">삼베 샤워타월</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Bath9_body end */}        
      </div>    {/** Pd_Bath9_Content end */}
      <div className="Pd_Bath9_Footer">
        <Footer />  
      </div>   {/** Pd_Bath9_Footer end */}
    </div>  /** Pd_Bath9_wrapper end */
  );
};

export default Pd_Bath9;