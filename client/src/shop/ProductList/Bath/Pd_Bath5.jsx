...
import siliconSoap_Support1 from "../../../assets/bath/5. siliconSoap_Support1.jpg"; 
import siliconSoap_Support2 from "../../../assets/bath/5. siliconSoap_Support2.jpg"; 
import siliconSoap_Support3 from "../../../assets/bath/5. siliconSoap_Support3.jpg"; 
import siliconSoap_Support4 from "../../../assets/bath/5. siliconSoap_Support4.jpg"; 
import siliconSoap_Support5 from "../../../assets/bath/5. siliconSoap_Support5.jpg"; 
import siliconSoap_SupportDesc1 from "../../../assets/bath/5. siliconSoap_SupportDesc1.jpg";

const Pd_Bath5 = () => {
  const images = [
    siliconSoap_Support1,
    siliconSoap_Support2,
    siliconSoap_Support3,
    siliconSoap_Support4,
    siliconSoap_Support5
  ];
  ...
  return (
    <div className="Pd_Bath5_wrapper">
      <div className="Pd_Bath5_Header">
        <Header_loginOK />  
      </div> {/** Pd_Bath5_Header end */}
      <div className="Pd_Bath5_Content">
         <div className="Pd_Bath5_body">
           <div id="detail">
                  ...
                  <div className="carousel_container">
                   ...
                   <div className="detail_info">
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 1st 이미지 (장원영 단독 착용사진) */}
                       <img src={siliconSoap_SupportDesc1} />
                     </div>    {/** img_wrapper end */}
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] 실리콘 비누받침 </h3>
                       <p className="summary">비누받침</p>
                       <div className="price">
         ...
         </div>   {/** Pd_Bath5_body end */}           
      </div>    {/** Pd_Bath5_Content end */}
      <div className="Pd_Bath5_Footer">
        <Footer />  
      </div>   {/** Pd_Bath5_Footer end */}
    </div>  /** Pd_Bath5_wrapper end */
  );
};

export default Pd_Bath5;