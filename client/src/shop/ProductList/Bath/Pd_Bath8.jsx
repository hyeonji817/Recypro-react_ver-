...
import zeroBodySet1 from "../../../assets/bath/8. zeroBodySet1.jpg";
import zeroBodySet2 from "../../../assets/bath/8. zeroBodySet2.jpg"; 
import zeroBodySet3 from "../../../assets/bath/8. zeroBodySet3.jpg";
import zeroBodySet_Desc1 from "../../../assets/bath/8. zeroBodySet_Desc1.jpg";
...
const Pd_Bath8 = () => {
  ...
  return (
    <div className="Pd_Bath8_wrapper">
      <div className="Pd_Bath8_Header">
        <Header_loginOK />  
      </div> {/** Pd_Bath8_Header end */}
      <div className="Pd_Bath8_Content">
         <div className="Pd_Bath8_body">
           <div id="detail">
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] 제로 바디 세트 </h3>
                       <p className="summary">바디세트</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">28,900 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="bodySet">바디세트</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Bath8_body end */}        
      </div>    {/** Pd_Bath8_Content end */}
      <div className="Pd_Bath8_Footer">
        <Footer />  
      </div>   {/** Pd_Bath8_Footer end */}
    </div>  /** Pd_Bath8_wrapper end */
  );
};

export default Pd_Bath8;