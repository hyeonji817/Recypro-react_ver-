...
import ActiveTumblur1 from "../../../assets/office/5. kinto_ActiveTumblur1.jpg";
import ActiveTumblur2 from "../../../assets/office/5. kinto_ActiveTumblur2.jpg";
...
const Pd_Office5 = () => {
  ...
  return (
    <div className="Pd_Office5_wrapper">
      <div className="Pd_Office5_Header">
        <Header_loginOK />  
      </div> {/** Pd_Office5_Header end */}
      <div className="Pd_Office5_Content">
         <div className="Pd_Office5_body">
           <div id="detail">
               ...
               <div className="prdimg">
                  <div className="carousel_container">
                    ...
                    <div className="add_img">
                      <img src={images[currentIndex]} alt={`킨토 액티브 텀블러 ${currentIndex + 1}`} />
                    </div>
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 킨토 액티브 텀블러 800ml </h3>
                       <p className="summary">액티브 텀블러 800ml</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">76,000 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="yellow">액티브 텀블러 800ml</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Office5_body end */}      
      </div>    {/** Pd_Office5_Content end */}
      <div className="Pd_Office5_Footer">
        <Footer />  
      </div>   {/** Pd_Office5_Footer end */}
    </div>  /** Pd_Office5_wrapper end */
  );
};

export default Pd_Office5;