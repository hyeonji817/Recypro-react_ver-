...
import stainlessHook1 from "../../../assets/office/2. stainlessHook1.jpg";
import stainlessHook2 from "../../../assets/office/2. stainlessHook2.jpg";
import stainlessHook3 from "../../../assets/office/2. stainlessHook3.jpg";
import stainlessHook_Desc from "../../../assets/office/2. stainlessHook_Desc1.jpg"; 
...
const Pd_Office2 = () => {
  ...
  return (
    <div className="Pd_Office2_wrapper">
      <div className="Pd_Office2_Header">
        <Header_loginOK />  
      </div> {/** Pd_Office2_Header end */}
      <div className="Pd_Office2_Content">
         <div className="Pd_Office2_body">
           <div id="detail">
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] S자 고리 (4개입) </h3>
                       <p className="summary">S자 고리</p>
                       <div className="price">
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="yellow">S자고리 (4개입)</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Office2_body end */}  
      </div>    {/** Pd_Office2_Content end */}
      <div className="Pd_Office2_Footer">
        <Footer />  
      </div>   {/** Pd_Office2_Footer end */}
    </div>  /** Pd_Office2_wrapper end */
  );
};

export default Pd_Office2;