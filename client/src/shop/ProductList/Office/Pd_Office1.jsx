...
import shoppingBag1 from "../../../assets/office/1. shoppingBag1.jpg";
import shoppingBag2 from "../../../assets/office/1. shoppingBag2.jpg";
import shoppingBag3 from "../../../assets/office/1. shoppingBag3.jpg";
import shoppingBag4 from "../../../assets/office/1. shoppingBag4.jpg";
...
const Pd_Office1 = () => {
  ...
  return (
    <div className="Pd_Office1_wrapper">
      <div className="Pd_Office1_Header">
        <Header_loginOK />  
      </div> {/** Pd_Office1_Header end */}
      <div className="Pd_Office1_Content">
         <div className="Pd_Office1_body">
           <div id="detail">
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] 업사이클 재생지 종이가방 (쇼핑백) </h3>
                       <p className="summary">종이쇼핑백</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">1,000 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="shoppingBag">재생지 종이가방 (쇼핑백)</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Office1_body end */}        
      </div>    {/** Pd_Office1_Content end */}
      <div className="Pd_Office1_Footer">
        <Footer />  
      </div>   {/** Pd_Office1_Footer end */}
    </div>  /** Pd_Office1_wrapper end */
  );
};

export default Pd_Office1;