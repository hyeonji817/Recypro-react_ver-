...
import TongsHanger1 from "../../../assets/office/3. stainless_TongsHanger1.jpg";
import TongsHanger2 from "../../../assets/office/3. stainless_TongsHanger2.jpg";
import TongsHanger3 from "../../../assets/office/3. stainless_TongsHanger3.jpg";
import TongsHanger4 from "../../../assets/office/3. stainless_TongsHanger4.jpg";
import TongsHanger_Desc from "../../../assets/office/3. stainless_TongsHanger_Desc1.jpg";
...
const Pd_Office3 = () => {
  ...
  return (
    <div className="Pd_Office3_wrapper">
      <div className="Pd_Office3_Header">
        <Header_loginOK />  
      </div> {/** Pd_Office3_Header end */}
      <div className="Pd_Office3_Content">
         <div className="Pd_Office3_body">
           <div id="detail">
               ...
               <div className="prdimg">
                  <div className="carousel_container">
                    ...
                    <div className="add_img">
                      <img src={images[currentIndex]} alt={`쇼핑백 ${currentIndex + 1}`} />
                    </div>
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] 스테인레스 집게 걸이 (5개세트) </h3>
                       <p className="summary">집게 걸이</p>
                       <div className="price">
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="yellow">집게걸이 (5개세트)</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Office3_body end */}    
      </div>    {/** Pd_Office3_Content end */}
      <div className="Pd_Office3_Footer">
        <Footer />  
      </div>   {/** Pd_Office3_Footer end */}
    </div>  /** Pd_Office3_wrapper end */
  );
};

export default Pd_Office3;