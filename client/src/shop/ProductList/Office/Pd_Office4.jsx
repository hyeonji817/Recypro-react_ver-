...
import waterBottle from "../../../assets/office/4. kinto_WaterBottle1.jpg";

const Pd_Office4 = () => {
  return (
    <div className="Pd_Office4_wrapper">
      <div className="Pd_Office4_Header">
        <Header_loginOK />  
      </div> {/** Pd_Office4_Header end */}
      <div className="Pd_Office4_Content">
         <div className="Pd_Office4_body">
           <div id="detail">
             <div className="detail_top_wrap">
               {/** 상품 이미지 */}
               <div className="prdimg">
                  <div className="add_img">
                     <img src={waterBottle} alt="물병" />
                   </div>
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 킨토 워터보틀 500ml </h3>
                       <p className="summary">휴대용 물컵</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">25,000 원 </span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="yellow">워터보틀 500ml</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Office4_body end */}       
      </div>    {/** Pd_Office4_Content end */}
      <div className="Pd_Office4_Footer">
        <Footer />  
      </div>   {/** Pd_Office4_Footer end */}
    </div>  /** Pd_Office4_wrapper end */
  );
};

export default Pd_Office4;