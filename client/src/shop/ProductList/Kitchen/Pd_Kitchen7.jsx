...
import siliconStraw1 from "../../../assets/kitchen/7. siliconStraw1.jpg"; 
import siliconStraw2 from "../../../assets/kitchen/7. siliconStraw2.jpg"; 
import siliconStraw_Desc from "../../../assets/kitchen/7. siliconStraw_Desc1.jpg";
...
const Pd_Kitchen7 = () => {
  ...
  return (
    <div className="Pd_Kitchen7_wrapper">
      <div className="Pd_Kitchen7_Header">
        <Header_loginOK />  
      </div> {/** Pd_Kitchen7_Header end */}
      <div className="Pd_Kitchen7_Content">
         <div className="Pd_Kitchen7_body">
           <div id="detail">
               ...
               <div className="prdimg">
                  <div className="carousel_container">
                    ...
                    <div className="add_img">
                      <img src={images[currentIndex]} alt={`실리콘 빨대 ${currentIndex + 1}`} />
                    </div>
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[에이비라이프] 개방형 실리콘빨대 (버블티용) </h3>
                       <p className="summary">실리콘 빨대</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">3,200 원</span>
         ...
         </div>   {/** Pd_Kitchen7_body end */}   
      </div>    {/** Pd_Kitchen7_Content end */}
      <div className="Pd_Kitchen7_Footer">
        <Footer />  
      </div>   {/** Pd_Kitchen7_Footer end */}
    </div>  /** Pd_Kitchen7_wrapper end */
  );
};

export default Pd_Kitchen7;