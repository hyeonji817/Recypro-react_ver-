...
import woodCutlery1 from "../../../assets/kitchen/5. woodCutlery1.jpg"; 
import woodCutlery2 from "../../../assets/kitchen/5. woodCutlery2.jpg"; 
import woodCutlery3 from "../../../assets/kitchen/5. woodCutlery3.jpg"; 
import woodCutlery4 from "../../../assets/kitchen/5. woodCutlery4.jpg"; 
import woodCutlery5 from "../../../assets/kitchen/5. woodCutlery5.jpg";  
import woodCutlery_Desc1 from "../../../assets/kitchen/5. woodCutlery_Desc1.jpg";
import woodCutlery_Desc2 from "../../../assets/kitchen/5. woodCutlery_Desc2.jpg";
import woodCutlery_Desc3 from "../../../assets/kitchen/5. woodCutlery_Desc3.jpg";
import woodCutlery_Desc4 from "../../../assets/kitchen/5. woodCutlery_Desc4.jpg";
import woodCutlery_Desc5 from "../../../assets/kitchen/5. woodCutlery_Desc5.jpg";
...
const Pd_Kitchen5 = () => {
  ...
  return (
    <div className="Pd_Kitchen5_wrapper">
      <div className="Pd_Kitchen5_Header">
        <Header_loginOK />  
      </div> {/** Pd_Kitchen5_Header end */}
      <div className="Pd_Kitchen5_Content">
         <div className="Pd_Kitchen5_body">
           <div id="detail">
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] 우드 커트러리 </h3>
                       <p className="summary">우드 커트러리</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">2,000 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="버터스푼::0::0::9508::cpx0::">버터스푼</option>
                             <option value="Jam_Spoon">잼 스푼</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Kitchen5_body end */}        
      </div>    {/** Pd_Kitchen5_Content end */}
      <div className="Pd_Kitchen5_Footer">
        <Footer />  
      </div>   {/** Pd_Kitchen5_Footer end */}
    </div>  /** Pd_Kitchen5_wrapper end */
  );
};

export default Pd_Kitchen5;