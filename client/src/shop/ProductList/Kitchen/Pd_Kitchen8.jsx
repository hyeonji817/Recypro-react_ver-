...
import washingUp from "../../../assets/kitchen/8. washingUp1.jpg"; 
import washingUp_Desc from "../../../assets/kitchen/8. washingUp_Desc1.jpg"; 

const Pd_Kitchen8 = () => {
  return (
    <div className="Pd_Kitchen8_wrapper">
      <div className="Pd_Kitchen8_Header">
        <Header_loginOK />  
      </div> {/** Pd_Kitchen8_Header end */}
      <div className="Pd_Kitchen8_Content">
         <div className="Pd_Kitchen8_body">
           <div id="detail">
             <div className="detail_top_wrap">
               {/** 상품 이미지 */}
               <div className="prdimg">
                 <div className="add_img">
                    <img src={washingUp} alt="아보카도 커플 키링" />
                 </div>
           
                   <div className="detail_info">
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 1st 이미지 (장원영 단독 착용사진) */}
                       <img src={washingUp_Desc} />
                     </div>    {/** img_wrapper end */}
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] 제로 설거지 세트 </h3>
                       <p className="summary">설거지 세트</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">21,900 원</span>
                           <span className="sell sellY">
                             <strong>19,710</strong>
                           </span>   {/** sell sellY end */}
                         </div>    {/** top_price end */}
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="washingUpSet">설거지세트</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Kitchen8_body end */}        
      </div>    {/** Pd_Kitchen8_Content end */}
      <div className="Pd_Kitchen8_Footer">
        <Footer />  
      </div>   {/** Pd_Kitchen8_Footer end */}
    </div>  /** Pd_Kitchen8_wrapper end */
  );
};

export default Pd_Kitchen8;