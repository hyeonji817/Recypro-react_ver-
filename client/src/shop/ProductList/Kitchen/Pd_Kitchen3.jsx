...
import colorWood_Spoons1 from "../../../assets/kitchen/3. colorWood_Spoons1.jpg"; 
import colorWood_Spoons2 from "../../../assets/kitchen/3. colorWood_Spoons2.jpg"; 
import colorWood_Spoons3 from "../../../assets/kitchen/3. colorWood_Spoons3.jpg"; 
import colorWood_SpoonsDesc1 from "../../../assets/kitchen/3. colorWood_SpoonsDesc1.jpg"; 
import colorWood_SpoonsDesc2 from "../../../assets/kitchen/3. colorWood_SpoonsDesc2.jpg"; 
import colorWood_SpoonsDesc3 from "../../../assets/kitchen/3. colorWood_SpoonsDesc3.jpg"; 
import colorWood_SpoonsDesc4 from "../../../assets/kitchen/3. colorWood_SpoonsDesc4.jpg"; 
...
const Pd_Kitchen3 = () => {
  ...
  return (
    <div className="Pd_Kitchen3_wrapper">
      <div className="Pd_Kitchen3_Header">
        <Header_loginOK />  
      </div> {/** Pd_Kitchen3_Header end */}
      <div className="Pd_Kitchen3_Content">
         <div className="Pd_Kitchen3_body">
           <div id="detail">
               ...
               <div className="prdimg">
                  <div className="carousel_container">
                    ...
                    <div className="add_img">
                      <img src={images[currentIndex]} alt={`나무 수저세트 ${currentIndex + 1}`} />
                    </div>
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] 컬러 나무 수저세트 L </h3>
                       <p className="summary">나무 수저세트</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">6,500 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="레드::0::0::9508::cpx0::">레드</option>
         ...
         </div>   {/** Pd_Kitchen3_body end */}        
      </div>    {/** Pd_Kitchen3_Content end */}
      <div className="Pd_Kitchen3_Footer">
        <Footer />  
      </div>   {/** Pd_Kitchen3_Footer end */}
    </div>  /** Pd_Kitchen3_wrapper end */
  );
};

export default Pd_Kitchen3;