...
import siliconLunchBox1 from "../../../assets/kitchen/6. siliconLunchBox1.jpg"; 
import siliconLunchBox2 from "../../../assets/kitchen/6. siliconLunchBox2.jpg"; 
import siliconLunchBox3 from "../../../assets/kitchen/6. siliconLunchBox3.jpg"; 
import siliconLunchBox4 from "../../../assets/kitchen/6. siliconLunchBox4.jpg"; 
import siliconLunchBox_Desc from "../../../assets/kitchen/6. siliconLunchBox_Desc1.jpg";
...
const Pd_Kitchen6 = () => {
  ...
  return (
    <div className="Pd_Kitchen6_wrapper">
      <div className="Pd_Kitchen6_Header">
        <Header_loginOK />  
      </div> {/** Pd_Kitchen6_Header end */}
      <div className="Pd_Kitchen6_Content">
         <div className="Pd_Kitchen6_body">
           <div id="detail">
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] 휴대용 접이식 실리콘 런치박스 </h3>
                       <p className="summary">접이식 실리콘 런치박스</p>
                       <div className="price">
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="핑크::0::0::9508::cpx0::">핑크</option>
         ...
         </div>   {/** Pd_Kitchen6_body end */}  
      </div>    {/** Pd_Kitchen6_Content end */}
      <div className="Pd_Kitchen6_Footer">
        <Footer />  
      </div>   {/** Pd_Kitchen6_Footer end */}
    </div>  /** Pd_Kitchen6_wrapper end */
  );
};

export default Pd_Kitchen6;