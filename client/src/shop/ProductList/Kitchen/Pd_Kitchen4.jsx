...
import ricePaddle1 from "../../../assets/kitchen/4. ricePaddle1.jpg"; 
import ricePaddle2 from "../../../assets/kitchen/4. ricePaddle2.jpg"; 
import ricePaddle_Desc from "../../../assets/kitchen/4. ricePaddle_Desc1.jpg";
...
const Pd_Kitchen4 = () => {
  ...
  return (
    <div className="Pd_Kitchen4_wrapper">
      <div className="Pd_Kitchen4_Header">
        <Header_loginOK />  
      </div> {/** Pd_Kitchen4_Header end */}
      <div className="Pd_Kitchen4_Content">
         <div className="Pd_Kitchen4_body">
           <div id="detail">
               ...
               <div className="prdimg">
                  <div className="carousel_container">
                    ...
                    <div className="add_img">
                      <img src={images[currentIndex]} alt={`나무 주걱 ${currentIndex + 1}`} />
                    </div>
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵] 나무 주걱 </h3>
                       <p className="summary">나무주걱</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">4,500 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="yellow">나무주걱</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Kitchen4_body end */}        
      </div>    {/** Pd_Kitchen4_Content end */}
      <div className="Pd_Kitchen4_Footer">
        <Footer />  
      </div>   {/** Pd_Kitchen4_Footer end */}
    </div>  /** Pd_Kitchen4_wrapper end */
  );
};

export default Pd_Kitchen4;