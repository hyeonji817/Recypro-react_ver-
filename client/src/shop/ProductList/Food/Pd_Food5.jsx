...
import Seasoning1 from "../../../assets/food/5. Seasoning1.jpg";
import Seasoning2 from "../../../assets/food/5. Seasoning2.jpg"; 
import Seasoning_Desc from "../../../assets/food/5. Seasoning_Desc1.jpg";
...
const Pd_Food5 = () => {
  ...
  return (
    <div className="Pd_Food5_wrapper">
      <div className="Pd_Food5_Header">
        <Header_loginOK />  
      </div> {/** Pd_Food5_Header end */}
      <div className="Pd_Food5_Content">
         <div className="Pd_Food5_body">
           <div id="detail">
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 의령농장 뽀시래기 천연조미료 </h3>
                       <p className="summary">천연조미료</p>
                       <div className="price">
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="pposiraegi">뽀시래기 천연조미료</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Food5_body end */}          
      </div>    {/** Pd_Food5_Content end */}
      <div className="Pd_Food5_Footer">
        <Footer />  
      </div>   {/** Pd_Food5_Footer end */}
    </div>  /** Pd_Food5_wrapper end */
  );
};

export default Pd_Food5;