...
import wheatCracker1 from "../../../assets/food/3. wheatCracker1.jpg";
import wheatCracker2 from "../../../assets/food/3. wheatCracker2.jpg";
import wheatCracker3 from "../../../assets/food/3. wheatCracker3.jpg"; 
import wheatCracker4 from "../../../assets/food/3. wheatCracker4.jpg"; 
import wheatCracker_Desc1 from "../../../assets/food/3. wheatCracker_Desc1.jpg";
import wheatCracker_Desc2 from "../../../assets/food/3. wheatCracker_Desc2.jpg";
import wheatCracker_Desc3 from "../../../assets/food/3. wheatCracker_Desc3.jpg";
import wheatCracker_Desc4 from "../../../assets/food/3. wheatCracker_Desc4.jpg";
import wheatCracker_Desc5 from "../../../assets/food/3. wheatCracker_Desc5.jpg";
import wheatCracker_Desc6 from "../../../assets/food/3. wheatCracker_Desc6.jpg";
import wheatCracker_Desc7 from "../../../assets/food/3. wheatCracker_Desc7.jpg";
import wheatCracker_Desc8 from "../../../assets/food/3. wheatCracker_Desc8.jpg";
import wheatCracker_Desc9 from "../../../assets/food/3. wheatCracker_Desc9.jpg";
import wheatCracker_Desc10 from "../../../assets/food/3. wheatCracker_Desc10.jpg";
...
const Pd_Food3 = () => {
  ...
  return (
    <div className="Pd_Food3_wrapper">
      <div className="Pd_Food3_Header">
        <Header_loginOK />  
      </div> {/** Pd_Food3_Header end */}
      <div className="Pd_Food3_Content">
         <div className="Pd_Food3_body">
           <div id="detail">
                  ...
                  <div className="carousel_container">
                   ...
                   <div className="detail_info">
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 1st 이미지 (장원영 단독 착용사진) */}
                       <img src={wheatCracker_Desc1} />
                     </div>    {/** img_wrapper end */}
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 2nd 이미지 (장원영 + 옷 단독 + 외국인 모델 착용사진) */}
                       <img src={wheatCracker_Desc2} />
                     </div>    {/** img_wrapper end */}
                     <div className="img _wrapper" style={{ textAlign: "center" }}>
                       <img src={wheatCracker_Desc3} />
                     </div>		{/** img_wrapper end */}
                     <div className="img _wrapper" style={{ textAlign: "center" }}>
                       <img src={wheatCracker_Desc4} />
                     </div>		{/** img_wrapper end */}
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 1st 이미지 (장원영 단독 착용사진) */}
                       <img src={wheatCracker_Desc5} />
                     </div>    {/** img_wrapper end */}
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 2nd 이미지 (장원영 + 옷 단독 + 외국인 모델 착용사진) */}
                       <img src={wheatCracker_Desc6} />
                     </div>    {/** img_wrapper end */}
                     <div className="img _wrapper" style={{ textAlign: "center" }}>
                       <img src={wheatCracker_Desc7} />
                     </div>		{/** img_wrapper end */}
                     <div className="img _wrapper" style={{ textAlign: "center" }}>
                       <img src={wheatCracker_Desc8} />
                     </div>		{/** img_wrapper end */}
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 1st 이미지 (장원영 단독 착용사진) */}
                       <img src={wheatCracker_Desc9} />
                     </div>    {/** img_wrapper end */}
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 2nd 이미지 (장원영 + 옷 단독 + 외국인 모델 착용사진) */}
                       <img src={wheatCracker_Desc10} />
                     </div>    {/** img_wrapper end */}
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구샵Pick] 잇츠베러 얼그레이 우리밀 크래커 </h3>
                       <p className="summary">얼그레이 우리밀 크래커</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">3,100 원</span>
         ...
         </div>   {/** Pd_Food3_body end */}          
      </div>    {/** Pd_Food3_Content end */}
      <div className="Pd_Food3_Footer">
        <Footer />  
      </div>   {/** Pd_Food3_Footer end */}
    </div>  /** Pd_Food3_wrapper end */
  );
};

export default Pd_Food3;