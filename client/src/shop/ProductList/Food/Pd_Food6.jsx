...
import swordBean_Tea1 from "../../../assets/food/6. swordBean_Tea1.jpg"; 
import swordBean_Tea2 from "../../../assets/food/6. swordBean_Tea2.jpg"; 
import swordBean_Tea3 from "../../../assets/food/6. swordBean_Tea3.jpg"; 
import swordBean_Tea4 from "../../../assets/food/6. swordBean_Tea4.jpg"; 
import swordBean_TeaDesc1 from "../../../assets/food/6. swordBean_TeaDesc1.jpg"; 
import swordBean_TeaDesc2 from "../../../assets/food/6. swordBean_TeaDesc2.jpg";
...
const Pd_Food6 = () => {
  ...
  return (
    <div className="Pd_Food6_wrapper">
      <div className="Pd_Food6_Header">
        <Header_loginOK />  
      </div> {/** Pd_Food6_Header end */}
      <div className="Pd_Food6_Content">
         <div className="Pd_Food6_body">
           <div id="detail">
               ...
               <div className="prdimg">
                  <div className="carousel_container">
                    ...
                    <div className="add_img">
                      <img src={images[currentIndex]} alt={`유기농 작두콩차 ${currentIndex + 1}`} />
                    </div>
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 창대농원 유기농 작두콩차 </h3>
                       <p className="summary">유기농 작두콩차</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">10,000 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="swordBean_Tea">작두콩차</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Food6_body end */}        
      </div>    {/** Pd_Food6_Content end */}
      <div className="Pd_Food6_Footer">
        <Footer />  
      </div>   {/** Pd_Food6_Footer end */}
    </div>  /** Pd_Food6_wrapper end */
  );
};

export default Pd_Food6;