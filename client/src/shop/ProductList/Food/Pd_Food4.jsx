...
import vegatableChip from "../../../assets/food/4. VegatableChip1.jpg"; 
import vegatableChip_Desc from "../../../assets/food/4. VegatableChip_Desc1.jpg";

const Pd_Food4 = () => {
  return (
    <div className="Pd_Food4_wrapper">
      <div className="Pd_Food4_Header">
        <Header_loginOK />  
      </div> {/** Pd_Food4_Header end */}
      <div className="Pd_Food4_Content">
         <div className="Pd_Food4_body">
           <div id="detail">
             <div className="detail_top_wrap">
               {/** 상품 이미지 */}
               <div className="prdimg">
                  <div className="add_img">
                    <img src={vegatableChip} alt="아보카도 커플 키링" />
                  </div>
           
                   <div className="detail_info">
                     <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 1st 이미지 (장원영 단독 착용사진) */}
                       <img src={vegatableChip_Desc} />
                     </div>    {/** img_wrapper end */}
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 오리얼 국산 야채칩 </h3>
                       <p className="summary">야채칩</p>
                       <div className="price">
                         <div className="top_price">
                           <span className="consumer consumerY">2,500 원</span>
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="vegatable_chip">야채칩</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Food4_body end */}          
      </div>    {/** Pd_Food4_Content end */}
      <div className="Pd_Food4_Footer">
        <Footer />  
      </div>   {/** Pd_Food4_Footer end */}
    </div>  /** Pd_Food4_wrapper end */
  );
};

export default Pd_Food4;