...
import sweetPotato_chip from "../../../assets/food/2. sweetPotato_chip1.jpg"; 
import sweetPotato_ChipDesc from "../../../assets/food/2. sweetPotato_chipDesc1.jpg";

const Pd_Food2 = () => {
  return (
    <div className="Pd_Food2_wrapper">
      <div className="Pd_Food2_Header">
        <Header_loginOK />  
      </div> {/** Pd_Food2_Header end */}
      <div className="Pd_Food2_Content">
         <div className="Pd_Food2_body">
           <div id="detail">
             <div className="detail_top_wrap">
               {/** 상품 이미지 */}
               <div className="prdimg">
                <div className="add_img">
                    <img src={sweetPotato_chip} alt="오리얼 국산 고구마칩" />
                </div>
           
                <div className="detail_info">
                  <div className="img_wrapper" style={{ textAlign: "center" }}>	{/** 1st 이미지 (장원영 단독 착용사진) */}
                    <img src={sweetPotato_ChipDesc} />
                  </div>    {/** img_wrapper end */}
               ...
               <div className="info_scroll">
                 <form name="prdFrm" method="post" style={{ margin: "0px" }} acceptCharset="utf-8">
                   <div className="wrap_prd">
                     {/** 상품정보 & 버튼 */}
                     <div className="info">
                       <h3 className="name">[지구pick] 오리얼 국산 고구마칩 </h3>
                       <p className="summary">국산 고구마칩</p>
                       <div className="price">
                       ...
                       <div className="opt_list">
                         ...
                         <div className="td">
                           <select name="option1" /** dataNecessary="Y" dataType="2A" dataName="색상"*/ className="wing_multi_option pno4844 necessary_Y" /** dataPno="4844" */>
                             ...
                             <option value="sweetPotato_Chip">국산 고구마칩</option>
                           </select>
                         </div>    {/** td end */}
                       </div>    {/** opt_list end */}
         ...
         </div>   {/** Pd_Food2_body end */}   
      </div>    {/** Pd_Food2_Content end */}
      <div className="Pd_Food2_Footer">
        <Footer />  
      </div>   {/** Pd_Food2_Footer end */}
    </div>  /** Pd_Food2_wrapper end */
  );
};

export default Pd_Food2;