...
const NewProducts = () => {
  ...
  useEffect(() => {
      const fetchNewArrivals = async () => {
        try {
          const res = await fetch("http://localhost:5103/api/newProducts", { // 여기서부터 credentials 까지는 새로 추가한 코드
            method: "GET", 
            credentials: "include", 
                ...
                <div className="box">
                  ...
                  <div className="info">
                    ...
                    <div className="price">
                      ...
                      <div className="discount_section" style={{ position: "relative", right: "130px"}}>
